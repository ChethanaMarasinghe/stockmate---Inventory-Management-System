...
class _HomeTabState extends State<HomeTab> {
  ...
  List<DocumentSnapshot> lowStockItems =
      []; // To store items with quantity less than 10
  Set<String> suppliersSet = {}; // To store unique suppliers' names
  ...
  Future<void> _fetchData() async {
    ...
    int totalQty = 0;
    Set<String> suppliers = {}; // Temporary set to hold unique suppliers
    List<DocumentSnapshot> lowStock =
        []; // Temporary list for items with quantity < 10
